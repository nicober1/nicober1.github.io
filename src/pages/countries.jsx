  ...
  return (
    <Layout noFooter wrapperClassName='countries-page'>
      <div className='container mx-auto'>
        <h1 className='mb-4 text-4xl font-bold '>Countries of the World</h1>
            ...
            return (
              <div key={country.cca3} className='overflow-hidden rounded-lg bg-white shadow-lg'>
                ...
                <div className='p-4'>
                  ...
                  <div className='mt-2'>
                    <span className='text-gray-600'>Capital:</span> <span className='font-semibold text-gray-900'>{country.capital}</span>
                  </div>
                  <div className='mt-2'>
                    <span className='text-gray-600'>Region:</span> <span className='font-semibold text-gray-900'>{country.region}</span>
                  </div>
                  <div className='mt-2'>
